    ...
    <div className="bg-white shadow border border-blue-800 rounded-lg">
      ...
      <div className="overflow-x-auto">
        <InfoRow
          ...
          leftValue="Yes"
          rightLabel="Date of Installation of Mobile Tower"
          rightValue="2025-05-27"
        />
        <InfoRow
        ...
        <InfoRow
          ...
          leftValue="Yes"
          rightLabel="Date of Installation of Hoarding Board(s)"
          rightValue="2025-05-27"
        />
        <InfoRow
        ...
        <InfoRow
          ...
          leftValue="Yes"
          rightLabel="Completion Date of Petrol Pump"
          rightValue="2025-05-20"
        />
        <InfoRow
        ...
        <InfoRow leftLabel="Rainwater harvesting provision?" leftValue="Yes" />
      </div>
    </div>
  );
};
