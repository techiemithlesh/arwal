...
import {
  getOwnershipTypeAddApi,
  getOwnershipTypeDtlApi,
  getOwnershipTypeEditApi,
} from "../../../api/endpoints";

export default function PropertyOwnershipTypeModal({
  item,
  onClose,
  onSuccess,
}) {
  ...
  const handleFormSubmit = async () => {
    ...
    const api = item?.id ? getOwnershipTypeEditApi : getOwnershipTypeAddApi;
    setIsFrozen(true);
