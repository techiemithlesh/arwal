...
import {
  getPropertyTypeAddApi,
  getPropertyTypeDtlApi,
  getPropertyTypeEditApi,
} from "../../../api/endpoints";

export default function PropertyPropTypeModal({ item, onClose, onSuccess }) {
  ...
  const handleFormSubmit = async () => {
    ...
    const api = item?.id ? getPropertyTypeEditApi : getPropertyTypeAddApi;
    setIsFrozen(true);
