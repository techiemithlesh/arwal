...
import {
  getFloorTypeListApi,
  getFloorTypeLockUnlockApi,
} from "../../../api/endpoints";
import { formatLocalDateTime } from "../../../utils/common"; // ✅ Added
import PropertyFloorTypeModal from "../components/PropertyFloorTypeModal";

export default function PropertyFloorTypeList() {
  ...
  const headers = [
    { label: "#", key: "serial" },
    { label: "Floor Type", key: "floorName" },
  ...
  const renderRow = (item, index, currentPage, perPage) => (
    <tr key={item.id} className="hover:bg-gray-50">
      ...
      <td className="px-3 py-2 border">{item.floorName}</td>
      <td className="px-3 py-2 border">
