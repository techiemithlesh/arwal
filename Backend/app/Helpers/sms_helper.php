...
if (!function_exists("OTP")) {
    function OTP($data = array(), $sms_for = null)
    {
        ...
        } elseif(strtoupper($sms_for)==strtoupper("Register")){
            try {
                #Dear Citizen, your SAF no is {#var#}. Please keep this as future reference number. For details call us @1800-123-7785              
                $sms = "Dear Citizen, your SAF no is ".$data["Otp"].". Please keep this as future reference number. For details call us @1800-123-7785";
                $temp_id = "1307161908224514374";
                return array("sms" => $sms, "temp_id" => $temp_id, 'status' => true);
            } catch (Exception $e) {
                return array(
                    "sms_formate" => "Dear Citizen, your SAF no is {#var#}. Please keep this as future reference number. For details call us @1800-123-7785",
                    "discriuption" => "1. 2 para required 
                      2. 1st para array('Otp'=>'') sizeof 1  
                      3. 2nd para sms for ",
                    "error" => $e->getMessage(),
                    'status' => false
                );
        ...
        elseif(strtoupper($sms_for)==strtoupper("Login")){
            try {
                #Dear Citizen, your SAF no is {#var#}. Please keep this as future reference number. For details call us @1800-123-7785              
                $sms = "Dear Citizen, your SAF no is ".$data["Otp"].". Please keep this as future reference number. For details call us @1800-123-7785";
                $temp_id = "1307161908224514374";
