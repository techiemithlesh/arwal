...
import {
  getConstructionTypeListApi,
  getConstructionTypeLockUnlockApi,
} from "../../../api/endpoints";
import { formatLocalDateTime } from "../../../utils/common"; // ✅ Added
import PropertyConstructionTypeModal from "../components/PropertyConstructionTypeModal";

export default function PropertyConstructionTypeList() {
  ...
  const renderRow = (item, index, currentPage, perPage) => (
    <tr key={item.id} className="hover:bg-gray-50">
      ...
      <td className="px-3 py-2 border">{item.constructionType}</td>
      <td className="px-3 py-2 border">
