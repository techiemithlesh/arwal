...
import {
  getOwnershipTypeListApi,
  getOwnershipTypeLockUnlockApi,
} from "../../../api/endpoints";
import { formatLocalDateTime } from "../../../utils/common"; // ✅ Added
import PropertyOwnershipTypeModal from "../components/PropertyOwnershipTypeModal";

export default function PropertyOwnershipTypeList() {
  ...
  const headers = [
    { label: "#", key: "serial" },
    { label: "Ownership Type", key: "ownershipType" },
  ...
  const renderRow = (item, index, currentPage, perPage) => (
    <tr key={item.id} className="hover:bg-gray-50">
      ...
      <td className="px-3 py-2 border">{item.ownershipType}</td>
      <td className="px-3 py-2 border">
