...
import {
  getRoadTypeListApi,
  getRoadTypeLockUnlockApi,
} from "../../../api/endpoints";
import { formatLocalDateTime } from "../../../utils/common"; // ✅ Added
import PropertyRoadTypeModal from "../components/PropertyRoadTypeModal";

export default function PropertyRoadTypeList() {
  ...
  const renderRow = (item, index, currentPage, perPage) => (
    <tr key={item.id} className="hover:bg-gray-50">
      ...
      <td className="px-3 py-2 border">{item.roadType}</td>
      <td className="px-3 py-2 border">
