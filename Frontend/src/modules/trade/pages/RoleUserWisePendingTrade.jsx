...
import { tradeLevelUserWisePendingApi } from "../../../api/endpoints";
import { exportToExcel, exportToPdf } from "../../../utils/exportUtils";
import { Link, createSearchParams, useSearchParams } from "react-router-dom";

function RoleUserWisePendingTrade() {
  ...
  const fetchData = async () => {
    setIsFrozen(true);
    try {
      const res = await axios.post(tradeLevelUserWisePendingApi, filters, {
  ...
  const handleExport = () => {
    const columns = [
      ...
      { key: "totalTrade", label: "Total No of App(s)" },
        ...
        >
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 border text-left">Total No of App(s)</th>
...
export default RoleUserWisePendingTrade;
